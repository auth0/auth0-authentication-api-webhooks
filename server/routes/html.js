...
module.exports = () => {
  ...
  <head>
    ...
    <% if (assets.version) { %><link rel="stylesheet" type="text/css" href="//cdn.auth0.com/extensions/auth0-authentication-api-webhooks/assets/auth0-authentication-api-webhooks.ui.<%= assets.version %>.css" /><% } %>
  ...
  <body>
    ...
    <% if (assets.version) { %>
    <script type="text/javascript" src="//cdn.auth0.com/extensions/auth0-authentication-api-webhooks/assets/auth0-authentication-api-webhooks.ui.vendors.<%= assets.version %>.js"></script>
    <script type="text/javascript" src="//cdn.auth0.com/extensions/auth0-authentication-api-webhooks/assets/auth0-authentication-api-webhooks.ui.<%= assets.version %>.js"></script>
    <% } %>
  </body>
  </html>
  `;
